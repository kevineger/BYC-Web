    ...
    <table class="ui single line table">
        ...
        @foreach($schools as $school)
            <tr>
                ...
                <td>
                    @if($school->featured)
                        <a id="{{ $school->id }}" data-featured="true" class="ui basic teal button"
                           onclick="setFeatured(event, 'school')">Set as not featured</a>
                        <a class="ui teal tag label">Featured</a>
                    @else
                        <a id="{{ $school->id }}" data-featured="false" class="ui basic orange button"
                           onclick="setFeatured(event, 'school')">Set As Featured</a>
                    @endif
                </td>
